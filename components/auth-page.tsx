...
import { AtSignIcon, ChevronLeftIcon, Key, KeyIcon } from "lucide-react";
      ...
      <div className="relative hidden h-full flex-col border-r bg-secondary p-10 lg:flex dark:bg-secondary/20">
        ...
        <div className="flex items-center">
          <Image
            ...
            className="w-11"
          />
          <h1 className="text-2xl font-semibold mt-2">ivorea</h1>
        </div>
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            ...
            <footer className="font-mono font-semibold text-sm">~ Ahmed</footer>
          </blockquote>
        </div>
